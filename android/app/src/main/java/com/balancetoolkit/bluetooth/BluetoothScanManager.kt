...
sealed class ScanEvent {
    data class DeviceFound(val name: String, val address: String) : ScanEvent()
    data class BalanceBoardFound(val device: BluetoothDevice) : ScanEvent()
    data class PairingSucceeded(val device: BluetoothDevice) : ScanEvent()
    data class PairingFailed(val reason: String) : ScanEvent()
    data class Error(val message: String) : ScanEvent()
    data class Log(val message: String) : ScanEvent()
}
