...
| `apps/gui/src-tauri/` | Desktop shell, Tauri commands and event serialization |
| `apps/gui/src/` | React UI, queries, frame storage and plots |
...
maintained manually in `apps/gui/src/types.ts` and `apps/gui/src/utils/requests.ts`.
